//Подробнее о работе написано в readme
  ...
  methods: {
    prev() {
      if(this.activeIndex > 0) {
        this.activeIndex -- //уходим назад
      }
    },
    reset() {
      this.activeIndex = 0 //сбрасываем индекс
      this.isVisible = true // отображаем скрытый элемент
    },
    nextOfFinish() {
      if(this.activeIndex < (this.steps.length -1)) {
        this.activeIndex ++ // если не дошли до конца, то идем дальше
      }
      else { this.isVisible = false // если в конце - скрываем кнопку
      }
    },
    setActive(idx) { //когда нажимаем на шаг сами
